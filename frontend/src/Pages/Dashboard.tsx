...
export const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if (savedHistory.length < 13 || userHistory.length < 13) {
      // Sincronizam in ambele parti
      localStorage.setItem("ordersHistory", JSON.stringify(testOrders));
      localStorage.setItem("userCreatedOrders", JSON.stringify(testOrders));
